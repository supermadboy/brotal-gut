...
export default function Oldhome() {
  return (
    <div className="bg-primary min-h-screen flex flex-col p-4">
      <div className="border-b flex flex-col grow py-2 md:py-6 md:flex-row md:gap-8 md:border-b-2 ">
        ...
        <div className="flex flex-col grow mt-4 md:mt-0 md:flex-1 md:flex-grow-[3]">
          <div className=" mb-4 md:mb-8 ">
            <Title className="uppercase mb-1 border-b md:border-b-2 md:mb-4">
              Inhaber
            </Title>
          ...
          <div className="flex flex-col grow justify-between md:justify-start md:grow-0">
            <div>
              ...
              <EmailLink mail="info@brotalgut-konstanz.de">
                <p>info@brotalgut-konstanz.de</p>
              </EmailLink>
            </div>
            <div>
              <Link
                className="text-3xl md:text-4.5xl hover:italic focus:italic hover:font-serif focus:font-serif"
                to="/impressum"
              >
                Impressum
              </Link>
